...
public final class FaceMeshTracker {
    ...
    private func updateSmoothedLandmarks(
        ...
        res.leftCheekApple = pt(50)   // Landmark 50: screen left cheek apple (x < 0.5, matches leftCheekCenter 205 & leftTemple 71)
        res.rightCheekApple = pt(280) // Landmark 280: screen right cheek apple (x > 0.5, matches rightCheekCenter 425 & rightTemple 301)
