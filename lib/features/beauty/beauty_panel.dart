...
class BeautyPanel extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tools = [
      ...
      {'id': 'eyeWrinkle', 'label': l10n.beautyEyeWrinkle, 'icon': Icons.blur_linear_outlined},
      {'id': 'crowsFeet', 'label': l10n.beautyCrowsFeet, 'icon': Icons.auto_fix_high_outlined},
    ...
    Widget buildCurrentSlider() {
      switch (subTool) {
        ...
        case 'eyeWrinkle':
          return BeautySlider(
            label: l10n.sliderEyeWrinkleReduction,
            value: b.eyeWrinkle,
            defaultValue: 0,
            onChanged: (v) => controller.updateBeauty(b.copyWith(eyeWrinkle: v)),
          );
        case 'crowsFeet':
          return BeautySlider(
            label: l10n.sliderCrowsFeet,
            value: b.crowsFeet,
            defaultValue: 0,
            onChanged: (v) => controller.updateBeauty(b.copyWith(crowsFeet: v)),
          );
        case 'teethWhitening':
          return BeautySlider(
