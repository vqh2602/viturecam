...
class PresetModel {
  ...
  static List<PresetModel> defaultPresets = [
    ...
    const PresetModel(
      ...
      name: 'Live Stream',
      isBuiltIn: true,
      beauty: BeautySettings(smooth: 65, whitening: 45, skinBrightness: 40, darkCircle: 60, eyeBag: 50, teethWhitening: 55),
    ...
    const PresetModel(
      ...
      name: 'Camera Ready',
      isBuiltIn: true,
      beauty: BeautySettings(smooth: 45, whitening: 30, skinBrightness: 25, darkCircle: 50, teethWhitening: 40),
